...
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-entry').submit(function (event) {
...
<div class="entry-edit front-end-edit">
	...
	<form id="form-entry"
		  action="<?php echo JRoute::_('index.php?option=com_astronomer&task=entry.save'); ?>"
	...
	<?php echo $this->form->renderField('created_by'); ?>
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-entry").appendChild(input);
                    });
                </script>
             <?php endif; ?>
		<div class="control-group">
			<div class="controls">
				...
				<?php endif; ?>
				<a class="btn"
				   href="<?php echo JRoute::_('index.php?option=com_astronomer&task=entryform.cancel'); ?>"

...
if($this->item->id) {
	$canState = JFactory::getUser()->authorise('core.edit.state','com_astronomer.astronomer');
} else {
	$canState = JFactory::getUser()->authorise('core.edit.state','com_astronomer.astronomer.'.$this->item->id);
}*/
?>
<script type="text/javascript">
	if (jQuery === 'undefined') {
		document.addEventListener("DOMContentLoaded", function (event) {
			jQuery('#form-astronomer').submit(function (event) {
...
<div class="astronomer-edit front-end-edit">
	...
	<form id="form-astronomer"
		  action="<?php echo JRoute::_('index.php?option=com_astronomer&task=astronomer.save'); ?>"
	...
	<?php echo $this->form->renderField('created_by'); ?>
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-astronomer").appendChild(input);
                    });
                </script>
             <?php endif; ?>
		<div class="control-group">
			<div class="controls">
				...
				<?php endif; ?>
				<a class="btn"
				   href="<?php echo JRoute::_('index.php?option=com_astronomer&task=astronomerform.cancel'); ?>"

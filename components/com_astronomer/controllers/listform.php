...
class AstronomerControllerListForm extends JControllerForm
{
	...
	public function edit()
	{
		...
		$this->setRedirect(JRoute::_('index.php?option=com_astronomer&view=listform&layout=edit', false));
	}
	...
	public function save()
	{
		...
		if ($data === false)
		{
			...
			$app->setUserState('com_astronomer.edit.list.data', $jform);

			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_astronomer.edit.list.id');
			$this->setRedirect(JRoute::_('index.php?option=com_astronomer&view=listform&layout=edit&id=' . $id, false));
		}
		...
		$app->setUserState('com_astronomer.edit.list.id', null);
	...
	public function cancel()
	{
		...
		$editId = (int) $app->getUserState('com_astronomer.edit.list.id');
	...
	public function remove()
	{
		...
		if (empty($data['id']))
		{
			...
			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_astronomer.edit.list.id');
			$this->setRedirect(JRoute::_('index.php?option=com_astronomer&view=list&layout=edit&id=' . $id, false));
		}

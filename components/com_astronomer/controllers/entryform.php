 ...
 * @since  1.6
 */
class AstronomerControllerEntryForm extends JControllerForm
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('EntryForm', 'AstronomerModel');
	...
	public function save()
	{
		...
		if ($data === false)
		{
			...
			$app->setUserState('com_astronomer.edit.entry.data', $jform);

			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_astronomer.edit.entry.id');
			$this->setRedirect(JRoute::_('index.php?option=com_astronomer&view=entryform&layout=edit&id=' . $id, false));
		}
		...
		{
			// Save the data in the session.
			$app->setUserState('com_astronomer.edit.entry.data', $data);
	...
	public function cancel()
	{
		...
		$editId = (int) $app->getUserState('com_astronomer.edit.entry.id');
	...
	public function remove()
	{
		...
		if (empty($data['id']))
		{
			...
			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_astronomer.edit.entry.id');
			$this->setRedirect(JRoute::_('index.php?option=com_astronomer&view=entry&layout=edit&id=' . $id, false));
		}

...
class AstronomerTableentry extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_astronomer.entry.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_astronomer/access.xml',
				"/access/section[@name='entry']/"
			);
			$default_actions = JAccess::getAssetRules('com_astronomer.entry.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_astronomer.entry.' . (int) $this->$k;
	}

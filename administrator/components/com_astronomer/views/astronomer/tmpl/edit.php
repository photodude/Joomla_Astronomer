...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'astronomer.cancel') {
			Joomla.submitform(task, document.getElementById('astronomer-form'));
		}
		else {
			
			if (task != 'astronomer.cancel' && document.formvalidator.isValid(document.id('astronomer-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="astronomer-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_ASTRONOMER_TITLE_ASTRONOMER', true)); ?>
		<div class="row-fluid">

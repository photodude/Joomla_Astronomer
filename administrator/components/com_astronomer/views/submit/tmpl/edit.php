...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'submit.cancel') {
			Joomla.submitform(task, document.getElementById('submit-form'));
		}
		else {
			
			if (task != 'submit.cancel' && document.formvalidator.isValid(document.id('submit-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="submit-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_ASTRONOMER_TITLE_SUBMIT', true)); ?>
		<div class="row-fluid">

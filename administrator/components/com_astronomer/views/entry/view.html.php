 ...
 * @since  1.6
 */
class AstronomerViewEntry extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ASTRONOMER_TITLE_ENTRY'), 'entry.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_astronomer.entry', $this->item->id);
		}

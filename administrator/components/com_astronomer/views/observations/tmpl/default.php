				...
				<tbody>
					...
					foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<?php if (isset($this->items[0]->state)): ?>
								<td class="center">
									<?php echo JHtml::_('jgrid.published', $item->state, $i, 'observations.', $canChange, 'cb'); ?>
								</td>
							<?php endif; ?>
							...
							<!-- force Observation entry box to only be 80 char wide -->
							<td style="max-width: 124px;">
								...
								<?php if ($canEdit) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_astronomer&task=submit.edit&id=' . (int) $item->id); ?>">
										<?php echo "<pre>" . $this->escape($item->observations); ?></pre></a>
								<?php else : ?>

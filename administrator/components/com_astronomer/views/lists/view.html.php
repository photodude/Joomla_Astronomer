...
class AstronomerViewLists extends JViewLegacy {
	...
	public function display($tpl = null) {
		...
		AstronomerHelpersAstronomer::addSubmenu('lists');
	...
	protected function addToolbar() {
		...
		JToolBarHelper::title(JText::_('COM_ASTRONOMER_TITLE_LISTS'), 'lists.png');
		...
		if (file_exists($formPath)) {
			if ($canDo->get('core.create')) {
				...
				JToolbarHelper::custom('lists.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}
		...
		JHtmlSidebar::setAction('index.php?option=com_astronomer&view=lists');

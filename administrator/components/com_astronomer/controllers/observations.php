 ...
 * @since  1.6
 */
class AstronomerControllerObservations extends JControllerAdmin
{
	/**
	 * Method to clone existing Observations
	 *
	 * @return void
	 */
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_astronomer&view=observations');
	}

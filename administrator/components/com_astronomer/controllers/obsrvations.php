 ...
 * @since  1.6
 */
class AstronomerControllerObsrvations extends JControllerAdmin
{
	/**
	 * Method to clone existing Obsrvations
	 *
	 * @return void
	 */
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_astronomer&view=obsrvations');
	}

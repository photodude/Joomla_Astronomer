...
<?php
	...
	$doc->_('bootstrap');
	$doc->_('forms');
	//$this->Toolbar->setTitle(l_('CONN_CREATE_TABLE'));
	$this->Toolbar->addButton('save', r_('index.php?ext=chronoconnectivity&act=create_table'), l_('CONN_SAVE'), $this->Assets->image('save', 'toolbar/'));
	$this->Toolbar->addButton('cancel', r_('index.php?ext=chronoconnectivity'), l_('CONN_CANCEL'), $this->Assets->image('cancel', 'toolbar/'), 'link');
?>
<?php
	ob_start();
?>
...
<div class="row" style="margin-top:20px;">
	<div class="col-md-6">
		<h3><?php echo l_('CONN_CREATE_TABLE'); ?></h3>
	</div>
...
<div class="row">
	<div class="panel panel-default">
		<div class="panel-body">
			<form action="<?php echo r_('index.php?ext=chronoconnectivity&act=create_table'); ?>" method="post" name="admin_form" id="admin_form">
				...
				<table class="table table-hover table-bordered">
					...
					<tbody>
						...
						<tr class="<?php echo isset($names[$i]) ? 'success' : 'danger'; ?>">
							...
							<td><?php echo $this->Html->input('columns['.$i.'][index]', array('type' => 'checkbox', 'sublabel' => 'Index', 'value' => 1)); ?></td>
						</tr>
						<?php endfor; ?>
					</tbody>
				</table>

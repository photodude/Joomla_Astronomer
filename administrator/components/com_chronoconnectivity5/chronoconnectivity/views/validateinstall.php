...
<?php
	...
	$doc->_('bootstrap');
	$doc->_('forms');
	//$this->Toolbar->setTitle('Validate your ChronoContact install');
	$this->Toolbar->addButton('add', r_('index.php?ext=chronoconnectivity&act=validateinstall'), 'Validate', $this->Assets->image('confirm', 'toolbar/'));
	$this->Toolbar->addButton('cancel', r_('index.php?ext=chronoconnectivity'), l_('CANCEL'), $this->Assets->image('cancel', 'toolbar/'), 'link');
?>
<div class="row" style="margin-top:20px;">
	<div class="col-md-6">
		<h3><?php echo l_('Validate your ChronoConnectivity5 install'); ?></h3>
	</div>
...
<div class="row">
	<div class="panel panel-default">
		<div class="panel-body">
			<form action="<?php echo r_('index.php?ext=chronoconnectivity&act=validateinstall'); ?>" method="post" name="admin_form" id="admin_form">
				...
				<?php echo $this->Html->formLine('pid', array('type' => 'dropdown', 'label' => 'Product', 'options' => array(15 => 'ChronoConnectivity 3 validation keys subscription', 8 => 'ChronoConnectivity 5 validation keys subscription', 17 => 'ChronoConnectivity Ultimate subscription'), 'sublabel' => 'Your subscription type')); ?>

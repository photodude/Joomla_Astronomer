...
foreach ($data as $line) {
	...
	/* is it a space? */ elseif ($line[12] <> "*" && $line[12] <> " ") {
		$invalid[] = $line;
		$badCount++;
	...
	/* does it have a space in cols 57-65? */ elseif (strcmp(substr($line, 56, 9), "         ")) {
		$invalid[] = $line;
		$badCount++;
	...
	/* does it have a space in cols 72-77? */ elseif (strcmp(substr($line, 71, 6), "      ")) {
		$invalid[] = $line;
		$badCount++;
